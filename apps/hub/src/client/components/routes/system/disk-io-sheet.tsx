...
import { DiskUtilizationChart, diskDataFns } from "./charts/disk-charts"
...
export default memo(function DiskIOSheet({
	...
	if (extraFsName) {
		weightedIOFn = showMax
			? diskDataFns.extraWeightedIOMax(extraFsName)
			: diskDataFns.extraWeightedIO(extraFsName)
	}
